...
Server-owned scheduled task runtime and routes for IPaper-only automation.
...
- This module is IPaper feature logic; it is intentionally separate from OpenCode proxy/runtime internals.
...
- Registers:
  ...
  - `GET /api/ipaper/scheduled-tasks/status`
  - `GET /api/ipaper/events`
