...
const RATE_LIMIT_MAX_ATTEMPTS = Number(process.env.IPAPER_RATE_LIMIT_MAX_ATTEMPTS) || 10;
const RATE_LIMIT_LOCKOUT_MS = 15 * 60 * 1000;
const RATE_LIMIT_CLEANUP_MS = 60 * 60 * 1000;
const RATE_LIMIT_NO_IP_MAX_ATTEMPTS = Number(process.env.IPAPER_RATE_LIMIT_NO_IP_MAX_ATTEMPTS) || 3;
...
const JWT_SECRET_FILE = path.join(IPAPER_DATA_DIR, 'jwt-secret');
...
function getOrCreateJwtSecret() {
  ...
  try {
    fs.mkdirSync(IPAPER_DATA_DIR, { recursive: true });
