import { RiBrainAi3Line, RiChatAi3Line, RiCommandLine, RiGitBranchLine, RiSettings3Line, RiStackLine, RiBookLine, RiPlugLine } from '@remixicon/react';
...
export const SIDEBAR_SECTIONS: SidebarSectionConfig[] = [
    ...
    },
    {
        id: 'settings',
        label: 'IPaper',
        description: 'IPaper app settings: themes, fonts, and preferences.',
