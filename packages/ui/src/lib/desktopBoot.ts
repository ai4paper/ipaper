 ...
 * it as `window.__IPAPER_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __IPAPER_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__IPAPER_DESKTOP_BOOT_OUTCOME__;
