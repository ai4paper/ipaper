...
export const PROJECT_ACTIONS_UPDATED_EVENT = 'ipaper:project-actions-updated';
...
export const getCurrentProjectActionPlatform = (): IPaperProjectActionPlatform => {
...
export const isProjectActionEnabledOnPlatform = (
  action: IPaperProjectAction,
  platform: IPaperProjectActionPlatform
): boolean => {
