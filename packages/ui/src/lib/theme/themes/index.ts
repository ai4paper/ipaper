...
import ipaperLightRaw from './fields-of-the-shire-light.json';
import ipaperDarkRaw from './fields-of-the-shire-dark.json';
...
export const ipaperLightTheme = withPrColors(ipaperLightRaw as Theme);
export const ipaperDarkTheme = withPrColors(ipaperDarkRaw as Theme);
...
export const themes: Theme[] = [
  ...
  flexokiDarkTheme,
  ...presetThemes.filter(
    (theme) => theme.metadata.id !== 'ipaper-light' && theme.metadata.id !== 'ipaper-dark',
  ),
];
