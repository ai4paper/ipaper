...
export const ProjectActionsButton = ({
  ...
  const [actions, setActions] = React.useState<IPaperProjectAction[]>([]);
  ...
  const getOrCreateActionTab = React.useCallback(async (action: IPaperProjectAction) => {
  ...
  const runAction = React.useCallback(async (action: IPaperProjectAction) => {
  ...
  const stopAction = React.useCallback(async (action: IPaperProjectAction) => {
    const runKey = toProjectActionRunKey(normalizedDirectory, action.id);
  ...
  const handleSelectAction = React.useCallback((action: IPaperProjectAction, toggleStopIfRunning = false) => {
