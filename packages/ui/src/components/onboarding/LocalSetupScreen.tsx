      ...
      <div className="w-full max-w-lg space-y-4 text-center">
        ...
        {platform === 'windows' && (
          <div className="mx-auto max-w-2xl rounded-lg border border-border bg-background/50 p-4 text-left">
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
              ...
              <li>If IPaper does not detect OpenCode automatically, set the binary path below.</li>
            </ol>
          </div>
        )}
        ...
        <div className="mx-auto w-full max-w-xl pt-4">
          <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground/70">Saves to IPaper settings and reloads OpenCode configuration.</div>
          </div>
        </div>
