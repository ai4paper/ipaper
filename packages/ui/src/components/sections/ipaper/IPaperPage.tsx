...
import { IPaperVisualSettings } from './IPaperVisualSettings';
...
import type { IPaperSection } from './types';

interface IPaperPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: IPaperSection;
}

export const IPaperPage: React.FC<IPaperPageProps> = ({ section }) => {
    ...
    if (!section) {
        return (
            <ScrollableOverlay
                ...
                className="w-full"
            >
                <div className="ipaper-page-body mx-auto max-w-3xl space-y-3 p-3 sm:space-y-6 sm:p-6 sm:pt-8">
                    <IPaperVisualSettings />
    ...
    return (
        <ScrollableOverlay
            ...
            className="w-full"
        >
            <div className="ipaper-page-body mx-auto max-w-3xl space-y-6 p-3 sm:p-6 sm:pt-8">
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <IPaperVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'timeFormat',
        'weekStart',
...
const ChatSectionContent: React.FC = () => {
    return <IPaperVisualSettings visibleSettings={['chatRenderMode', 'activityRenderMode', 'userMessageRendering', 'mermaidRendering', 'reasoning', 'showToolFileIcons', 'expandedTools', 'stickyUserHeader', 'diffLayout', 'mobileStatusBar', 'dotfiles', 'queueMode', 'persistDraft', 'inputSpellcheck']} />;
};
