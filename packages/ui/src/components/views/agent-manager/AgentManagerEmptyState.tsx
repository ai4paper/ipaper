...
import { getWorktreeSetupCommands } from '@/lib/ipaperConfig';
import { useThemeSystem } from '@/contexts/useThemeSystem';
import type { ProjectRef } from '@/lib/ipaperConfig';
...
export const AgentManagerEmptyState: React.FC<AgentManagerEmptyStateProps> = ({ 
  ...
  const isVSCodeRuntime = React.useMemo(() => {
    ...
    const apis = (window as unknown as { __IPAPER_RUNTIME_APIS__?: { runtime?: { isVSCode?: boolean } } }).__IPAPER_RUNTIME_APIS__;
