...
export const FilesView: React.FC<FilesViewProps> = ({ mode = 'full' }) => {
  ...
  const MD_VIEWER_MODE_KEY = 'ipaper:files:md-viewer-mode';
  ...
  const JSON_VIEWER_MODE_KEY = 'ipaper:files:json-viewer-mode';
  ...
  const HTML_VIEWER_MODE_KEY = 'ipaper:files:html-viewer-mode';
