...
import type { IPaperSection } from '@/components/sections/ipaper/types';
import { IPaperPage } from '@/components/sections/ipaper/IPaperPage';
...
export const SettingsView: React.FC<SettingsViewProps> = ({ onClose, forceMobile, isWindowed }) => {
  ...
  const openChamberSectionBySlug: Partial<Record<SettingsPageSlug, IPaperSection>> = React.useMemo(() => ({
    appearance: 'visual',
    chat: 'chat',
    shortcuts: 'shortcuts',
    sessions: 'sessions',
