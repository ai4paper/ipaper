...
const MENU_ACTION_EVENT = 'ipaper:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'ipaper:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('ipaper:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('ipaper:check-for-updates', () => {
